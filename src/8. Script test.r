...
wte    <- terra::rast("WorldEcosystem.tif")
...
graphA <- ggplot() +
  ...
  scale_fill_manual(values = c("Cardamine bellidifolia" = "#1d3557",
                               "Cardamine hirsuta"      = "#e63946"),
                    guide = "none") +
...
graphD <- ggplot(df, aes(x = elevation, y = temp, color = species)) +
  ...
  scale_color_manual(
    values = c("Cardamine bellidifolia" = "#1d3557",
               "Cardamine hirsuta"      = "#e63946"),
    name = "Espèce"
  ) +
...
print(figure_finale)
#Prof : J'aimerais bien qu'à la fin du projet, 
#vous ayez au moins une figure composite comme celle-ci

# ============================================================
#  EXPORT
# ============================================================

ggsave("figure_cardamine_suisse.png", figure_finale,
       width = 13, height = 16, dpi = 300, bg = "white")

ggsave("figure_cardamine_suisse.pdf", figure_finale,
